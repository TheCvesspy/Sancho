...
interface LocationDocumentsPanelProps {
    eventId: string;
    locationId: string;
...
export function LocationDocumentsPanel({ eventId, locationId, initialDocuments, canWrite, token }: LocationDocumentsPanelProps) {
