...
import { ArrowLeft, Trash2, RotateCcw, Lock } from "lucide-react";
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="md:col-span-2 space-y-6">
                            <div className="bg-card rounded-lg border p-6">
                                <h3 className="text-lg font-semibold mb-4 text-foreground/80 border-b pb-2">Biography & Public Story</h3>
                                {character.biography ? (
                        ...
                        <div className="space-y-6">
                            {(isOrgOrSysAdmin || character.notes) && (
                                <div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg border border-amber-200 dark:border-amber-900/50 p-6">
                                    <h3 className="text-lg font-semibold mb-2 text-amber-900 dark:text-amber-500 flex items-center gap-2">
                                        Internal Notes
                                    ...
                                    {character.notes ? (
                                        <div className="text-sm text-amber-950 dark:text-amber-200 whitespace-pre-wrap">
                                            {character.notes}
                                        </div>
                                    ) : (
                                        <p className="text-amber-700/60 dark:text-amber-700 italic text-sm">No internal notes.</p>
                                    )}
                                </div>
                            )}
                        </div>
